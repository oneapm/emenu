...
<form name="userLoginActionForm" id="userLoginActionForm" method="post" action="login">
	<input type="text" autofocus="true" id="username" name="username" value="账户..." maxlength="20" onfocus="userValue()"  />
    <input type="password" id="password" name="password" value="密码..." onfocus="hide_pw()" />
